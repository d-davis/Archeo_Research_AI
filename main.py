...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Geospatial AI Assistant -- Phase 1.0 (Prototype)',
            ...
            with Progress(SpinnerColumn(), TextColumn('[progress.description]{task.description}'),
                ...
                for result in imagery_items:
                    ...
                    if result.get('_from_pdf'):
                        ...
                        # Standalone image: thumbnail was already generated
                        # during preprocessing (imagery.py), no need to re-derive
                        # the file path.
                        ...
                        if thumb:
                            ...
                            result['vision_description'] = 'No thumbnail available for vision model.'
                    prog.remove_task(task)
...
def main():
    ...
    console.print(Panel.fit(
        '[bold]Geospatial Data AI Assistant[/bold]\n'
        '[dim]Phase 1.0: Protype[/dim]',
        border_style='dim'
    ))
